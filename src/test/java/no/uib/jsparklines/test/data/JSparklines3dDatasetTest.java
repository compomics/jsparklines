...
public class JSparklines3dDatasetTest extends TestCase {
    ...
    public void testJSparklines3dDataset() throws Exception {
        ...
        // set up the data
        ArrayList<JSparklines3dDataSeries> data = new ArrayList<JSparklines3dDataSeries>();

        ArrayList<XYZDataPoint> xyz = new ArrayList<XYZDataPoint>();
        ...
        xyz = new ArrayList<XYZDataPoint>();
        ...
        // test toString
        Assert.assertEquals("[(1.1, 1.2, 1.3), (2.1, 2.2, 2.3), (3.1, 3.2, 3.3)], [(4.1, 4.2, 4.3), (5.1, 5.2, 5.3), (6.1, 6.2, 6.3)]", dataset.toString());
    }
}
